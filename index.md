...
<div class="hero-grid">
  <a class="hero-card" href="{{ '/intro-enms/' | relative_url }}">
    <strong>Week 1: Introduction</strong>
    <span>Concepts, intuition, and the physical basis of elastic network models.</span>
  </a>
  <a class="hero-card" href="{{ '/py-rcsb-api/' | relative_url }}">
    <strong>Week 1: py-rcsb-api</strong>
    <span>Search and data API examples for retrieving PDB information.</span>
  </a>
  <a class="hero-card" href="{{ '/two-particle-motion/' | relative_url }}">
    <strong>Two-particle motion</strong>
    <span>Optional theory notes on harmonic potentials, oscillators, and motion.</span>
  </a>
  <a class="hero-card" href="{{ '/outline/' | relative_url }}">
...
- [Home]({{ '/' | relative_url }})
- [Week 1: Introduction]({{ '/intro-enms/' | relative_url }})
- [Week 1: py-rcsb-api]({{ '/py-rcsb-api/' | relative_url }})
- [Two-particle motion]({{ '/two-particle-motion/' | relative_url }})
- [Workshop Outline]({{ '/outline/' | relative_url }})
