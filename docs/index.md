...
Push this repository to GitHub, then in the repository settings enable **Pages** and publish from the `docs/` folder on your default branch. GitHub will render these markdown files through Jekyll automatically.
